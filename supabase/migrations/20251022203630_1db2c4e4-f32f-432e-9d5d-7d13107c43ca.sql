-- Fix revenue and margin calculation in get_lifecycle_insights function
  ...
  RETURN QUERY EXECUTE format('
    ...
    ORDER BY 
      CASE s.lifecycle
        ...
        ELSE 9
      END
  ', frequency_col, revenue_col, revenue_col, frequency_col, margin_col, margin_col, frequency_col);
END;
$$;